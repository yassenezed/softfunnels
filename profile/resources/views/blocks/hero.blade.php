...
<form method="post" action="{{ route('build.index', [ 'type' => $type,'id' => $id ]) }}" enctype="multipart/form-data">
    ...
    <div id="questions-container">
        ...
        <div class="card mb-3 question-container">
            <div class="card-body">
                <div class="mb-3">
                    <label for="imgid" class="form-label h4">Choisir une image pour la carrousel {{ $index + 1 }}</label>
                ...
                <div class="form-group mb-2">
                    <label for="" class="form-label">Titre de l'image caroussel {{ $index + 1 }} :</label>
                    <input type="text" name="details[{{ $index }}][text]" class="form-control question-input" value="{{ $detail['text'] }}">
                </div>

                <div class="form-group mb-2">
                    <label for="">Descirption de l'image caroussel {{ $index + 1 }} : </label>
