...
// });
//Redirect the official to homepage
Route::get('/', function () {
...
Route::get('stripe/renew/success', [StripeController::class, 'renewsuccess'])->name('stripe.renewsuccess');
Route::get('stripe/renew/success/renew', [StripeController::class, 'renewstripe'])->name('renew.stripe');

Route::get('/renouveller', [StripeController::class, 'renouveller'])->name('renouveller');
